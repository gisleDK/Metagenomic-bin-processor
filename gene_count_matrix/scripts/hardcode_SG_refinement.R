...
# initializing
work_dir = "/home/projects/cu_10108/people/trizac/VAMB_genes/signature_genes/"
data_dir = "/home/projects/cu_10108/people/trizac/VAMB_genes/signature_genes/"
setwd(work_dir)


Clusterlist <- readRDS(paste(data_dir, "cluster.RDS", sep=""))
GeneLengths <- readRDS(paste(data_dir, 'gene_lengths.RDS', sep=""))

source("/home/projects/cu_10108/people/trizac/Metagenomic-bin-processor/gene_count_matrix/scripts/Functions_v4.R")
...
saveRDS(outputs_parallel, file=paste(data_dir, "/VAMB_refined.RDS", sep=""))
