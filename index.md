...
5. We should set a lower-cutoff limit for contig size. You can use [this script](https://github.com/gisleDK/Biopythonpieces/blob/master/Scripts/fasta_select_size.py).
6. [This script] maps reads using [Minimap2](https://github.com/ablab/spades)
7. Contig coverage using JGIs [jgi_summarize_bam_contig_depths](https://bitbucket.org/berkeleylab/metabat/src/master/), which is actually part of the Metabat binner.
